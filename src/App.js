        ...
        {this.state.showSearchPage ? (
          ...
          <div className="list-books">
            ...
            <div className="list-books-content">
              <div>
                <Bookshelf title="Currently Reading" books={books_currently_reading} />
                <Bookshelf title="Want to Read" books={books_want_to_read} />
